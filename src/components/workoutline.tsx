...
const WorkoutLine = ({ exercise, reps, weight }: Props) => {
  const gridCols =
    reps.length === 0 ? 'grid grid-cols-2' : `grid-cols-${reps.length + 1}` // vairavel que controla tamanho de colunas do grid
  return (
    <div className="grid grid-cols-2 border-b-2 border-black px-4 py-2 text-black">
      ...
      <div className={`grid ${gridCols}`}>
        ...
        {reps.map((item, index) => {
          return (
            <div key={index} className="border-r border-black text-center">
